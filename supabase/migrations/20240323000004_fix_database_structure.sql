...
-- Create brands table before cars (since cars references brands)
create table brands (
...
-- Create cars table with proper foreign key to brands
create table cars (
  id uuid default gen_random_uuid() primary key,
...
-- Insert sample cars with proper brand_id references
